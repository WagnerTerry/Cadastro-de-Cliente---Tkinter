...
class Relatorios():
    ...
    def gerarRelatCliente(self):
        ...
        # self.c.drawString(50, 700, 'Codigo: ' + self.codigoRel) - forma alternativa
        ...
        self.c.rect(20, 550, 550, 5, fill=True, stroke=False) # Cria uma moldura
...
class Funcs():
    ...
    def add_cliente(self):
        ...
        if self.nome_entry.get() == "":
            ...
            messagebox.showinfo("Cadastro de Cliente", msg)
    ...
    def busca_cliente(self):
        self.conecta_bd()
        self.listaCli.delete(*self.listaCli.get_children()) #Apaga a lista antes de fazer a busca
...
class Application(Funcs, Relatorios, Validadores):
    ...
    def widgets_frame1(self):
        ...
        ### Testando nova janela com o botao de buscar
        # self.bt_janela2 = Button(self.aba1, text="Buscar", bd=2, bg="#107db2", fg="white",
        #                         activebackground='#108ecb', activeforeground="white",
        #                         font=('verdana', 8, 'bold'), command=self.janela2)
        # self.bt_janela2.place(relx=0.3, rely=0.1, relwidth=0.1, relheight=0.15)

        ### Criação do botão novo
        ### imgNovo botao como imagem alternativo
        self.btnovo = PhotoImage(data=base64.b64decode(self.btnovo_base64))
        self.btnovo = self.btnovo.subsample(2, 2)

        #botao como imagem base 64
        # self.bt_novo = Button(self.frame_1, image=self.btnovo, bd=0,  command=self.add_cliente)
        # self.bt_novo.place(relx=0.58, rely=0.1, width=60, height=30)

        self.bt_novo = Button(self.aba1, text="Novo",  bd=2, bg="#107db2", fg="white",
                                font=('verdana', 8, 'bold'), command = self.add_cliente)
        self.bt_novo.place(relx=0.6, rely=0.1, relwidth=0.1, relheight=0.15)

        ### Criação do botão alterar
        self.bt_alterar = Button(self.aba1, text="Alterar",  bd=2, bg="#107db2", fg="white",
    ...
    def lista_frame2(self):
        ...
        self.listaCli.bind("<Double-1>", self.OnDoubleClick) #Função duplo clique
    ...
    def janela2(self):
        ...
        self.root2.transient(self.root) #De onde vem da tela principal
